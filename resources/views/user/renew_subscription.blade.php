...
<body>
    ...
    <div class="py-5 px-2 px-md-3 px-lg-5 d-flex flex-column justify-content-center align-items-center text-center" div="" style="min-height: 80vh;">
        <div id="start">
            <h1 class="text-capitalize mb-4">It seems that your subscription has expired</h1>
            <button class="btn btn-primary rounded-pill" id="set_up_btn" type="button" style="background: var(--color-main);">Click Here To renew your subscription</button>
        </div>
        <div id="details" class="py-4" style="display: none;">
            <form method="get" action="{{url('post_renew_sub')}}">
                @csrf
                ...
                <div class="py-2">
                    <h4>all you have to do is to choose a plan and pay.. and your account is back online</h4>
                </div>
                    ...
                    <div id="payments" class="row py-3 justify-content-center">
                        <div id="airtel_money" class="col-lg-3 col-md-6 p-3">
                            <div class="p-3 shadow" style="cursor: pointer;">
                                ...
                                <div class="py-2 pay_details" style="display: none;">
                                    <p>send <span class="amount">##</span>&nbsp;to 099123456 then enter your transID below</p>
                        ...
                        <div id="tnm_mpamba" class="col-lg-3 col-md-6 p-3">
                            <div class="p-3 shadow" style="cursor: pointer;">
                                ...
                                <div class="py-2 pay_details" style="display: none;">
                                    <p>send <span class="amount">##</span>&nbsp;to 088123456 then enter your transID below</p>
                                    <input class="form-control" type="text" placeholder="Enter TransID">
                                </div>
                            </div>
                        </div>
