        ...
        <div class="col-lg-6 p-4">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="col-lg-6 py-2">
                    ...
                    <input class="form-control" type="text" id="phone" name="lname" placeholder="enter your phone number" required="">
                </div>
                <div class="col-lg-6 py-2">
                ...
                <div class="col-12 text-center p-2">
                    <button class="btn btn-primary text-capitalize" type="submit" style="background: var(--color-main);">Apply</button>
                </div>
            </form>
